...
Game.prototype.placeBombs = function() {
	while (this.bombs > 0){
		var xrand = Game.prototype.getRandomArbitrary(0,Game.prototype.size)
		var yrand = Game.prototype.getRandomArbitrary(0,Game.prototype.size)
	...
	document.getElementById('bombCount').innerHTML = `${Game.prototype.bombsPlaced}`
}
...
Game.prototype.checkBombs = function() {
	...
	alert(`You uncovered ${c} bombs out of ${Game.prototype.bombsPlaced} bombs.`)
...
Game.prototype.uncoverBomb = function(cell) {
	if (Game.prototype.bombsCovered[`${cell.x},${cell.y}`]) {
